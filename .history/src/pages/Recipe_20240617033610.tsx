        ...
        <TextContainer>
          {activeTab === "instructions" && (
            <div>
              ...
              <Text dangerouslySetInnerHTML={{ __html: details.instructions }} />
            </div>
          )}
...
const Info = styled.div`
  ...
  max-width: 500px; /* Set a max-width to prevent shifting */
`;

const ButtonContainer = styled.div`
  display: flex;
  gap: 1rem;
  margin-top: -1rem; /* Move the buttons up a bit */
`;

const TextContainer = styled.div`
  width: 100%;
  max-width: 500px; /* Fix the width to prevent shifting */
`;

const Text = styled.h3`
  color: white; /* White color for summary and instructions */
  font-size: 1rem; /* Ensure the font size matches the ingredients */
  margin-top: 1rem;
`;

const IngredientItem = styled.li`
  color: white; /* White color for ingredients */
